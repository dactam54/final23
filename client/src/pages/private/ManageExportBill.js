...
import { apiPhieuKhoXuat,apiGetAllPhieuXuat} from "../../apis";
...
const ManageExportBill = () => {
  ...
  return (
    ...
    <h3 className="font-bold text-[30px] pb-2 ">Thông tin phiếu xuất</h3>
    <Paper sx={{ width: "100%" }}>
...
export default ManageExportBill;
